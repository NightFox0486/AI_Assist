...
sys.path.insert(0, 'RealTime_zeroshot_TTS_ko/MeloTTS')
sys.path.insert(0, 'RealTime_zeroshot_TTS_ko')
...
whisper_model = WhisperModel("medium", device="cpu", compute_type="int8", num_workers=4)
...
def text_to_speech(text):
    ...
    if not os.path.exists(output_file):
        print(f"Warning: Output file {output_file} not created")
